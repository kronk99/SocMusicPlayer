...
module SOC_mm_interconnect_0 (
	...
	wire  [14:0] audio_0_avalon_audio_slave_agent_m0_address;                                      // audio_0_avalon_audio_slave_agent:m0_address -> audio_0_avalon_audio_slave_translator:uav_address
	...
	wire  [91:0] audio_0_avalon_audio_slave_agent_rf_source_data;                                  // audio_0_avalon_audio_slave_agent:rf_source_data -> audio_0_avalon_audio_slave_agent_rsp_fifo:in_data
	...
	wire  [91:0] audio_0_avalon_audio_slave_agent_rsp_fifo_out_data;                               // audio_0_avalon_audio_slave_agent_rsp_fifo:out_data -> audio_0_avalon_audio_slave_agent:rf_sink_data
	...
	wire  [90:0] cmd_mux_src_data;                                                                 // cmd_mux:src_data -> audio_0_avalon_audio_slave_agent:cp_data
	wire         cmd_mux_src_ready;                                                                // audio_0_avalon_audio_slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [6:0] cmd_mux_src_channel;                                                              // cmd_mux:src_channel -> audio_0_avalon_audio_slave_agent:cp_channel
	...
	wire  [14:0] audio_and_video_config_0_avalon_av_config_slave_agent_m0_address;                 // audio_and_video_config_0_avalon_av_config_slave_agent:m0_address -> audio_and_video_config_0_avalon_av_config_slave_translator:uav_address
	...
	wire  [91:0] audio_and_video_config_0_avalon_av_config_slave_agent_rf_source_data;             // audio_and_video_config_0_avalon_av_config_slave_agent:rf_source_data -> audio_and_video_config_0_avalon_av_config_slave_agent_rsp_fifo:in_data
	...
	wire  [91:0] audio_and_video_config_0_avalon_av_config_slave_agent_rsp_fifo_out_data;          // audio_and_video_config_0_avalon_av_config_slave_agent_rsp_fifo:out_data -> audio_and_video_config_0_avalon_av_config_slave_agent:rf_sink_data
	...
	wire  [90:0] cmd_mux_001_src_data;                                                             // cmd_mux_001:src_data -> audio_and_video_config_0_avalon_av_config_slave_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                            // audio_and_video_config_0_avalon_av_config_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [6:0] cmd_mux_001_src_channel;                                                          // cmd_mux_001:src_channel -> audio_and_video_config_0_avalon_av_config_slave_agent:cp_channel
	...
	wire   [6:0] cmd_mux_002_src_channel;                                                          // cmd_mux_002:src_channel -> NIOS_debug_mem_slave_agent:cp_channel
	...
	wire  [14:0] fifo_in_agent_m0_address;                                                         // FIFO_in_agent:m0_address -> FIFO_in_translator:uav_address
	...
	wire  [91:0] fifo_in_agent_rf_source_data;                                                     // FIFO_in_agent:rf_source_data -> FIFO_in_agent_rsp_fifo:in_data
	...
	wire  [91:0] fifo_in_agent_rsp_fifo_out_data;                                                  // FIFO_in_agent_rsp_fifo:out_data -> FIFO_in_agent:rf_sink_data
	...
	wire  [90:0] cmd_mux_003_src_data;                                                             // cmd_mux_003:src_data -> FIFO_in_agent:cp_data
	...
	wire  [14:0] fifo_in_csr_agent_m0_address;                                                     // FIFO_in_csr_agent:m0_address -> FIFO_in_csr_translator:uav_address
	...
	wire  [91:0] fifo_in_csr_agent_rf_source_data;                                                 // FIFO_in_csr_agent:rf_source_data -> FIFO_in_csr_agent_rsp_fifo:in_data
	...
	wire  [91:0] fifo_in_csr_agent_rsp_fifo_out_data;                                              // FIFO_in_csr_agent_rsp_fifo:out_data -> FIFO_in_csr_agent:rf_sink_data
	...
	wire  [90:0] cmd_mux_004_src_data;                                                             // cmd_mux_004:src_data -> FIFO_in_csr_agent:cp_data
	...
	wire  [91:0] fifo_out_agent_rf_source_data;                                                    // FIFO_out_agent:rf_source_data -> FIFO_out_agent_rsp_fifo:in_data
	...
	wire  [91:0] fifo_out_agent_rsp_fifo_out_data;                                                 // FIFO_out_agent_rsp_fifo:out_data -> FIFO_out_agent:rf_sink_data
	...
	wire  [90:0] cmd_mux_005_src_data;                                                             // cmd_mux_005:src_data -> FIFO_out_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                            // FIFO_out_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [6:0] cmd_mux_005_src_channel;                                                          // cmd_mux_005:src_channel -> FIFO_out_agent:cp_channel
	...
	wire  [90:0] cmd_mux_006_src_data;                                                             // cmd_mux_006:src_data -> RAM_s1_agent:cp_data
	...
	wire  [90:0] audio_0_avalon_audio_slave_agent_rp_data;                                         // audio_0_avalon_audio_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [90:0] audio_and_video_config_0_avalon_av_config_slave_agent_rp_data;                    // audio_and_video_config_0_avalon_av_config_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [90:0] fifo_in_agent_rp_data;                                                            // FIFO_in_agent:rp_data -> router_005:sink_data
	...
	wire  [90:0] fifo_in_csr_agent_rp_data;                                                        // FIFO_in_csr_agent:rp_data -> router_006:sink_data
	...
	wire  [90:0] fifo_out_agent_rp_data;                                                           // FIFO_out_agent:rp_data -> router_007:sink_data
	...
	wire  [90:0] ram_s1_agent_rp_data;                                                             // RAM_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [90:0] router_src_data;                                                                  // router:src_data -> NIOS_data_master_limiter:cmd_sink_data
	...
	wire  [90:0] nios_data_master_limiter_cmd_src_data;                                            // NIOS_data_master_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [90:0] rsp_mux_src_data;                                                                 // rsp_mux:src_data -> NIOS_data_master_limiter:rsp_sink_data
	...
	wire  [90:0] nios_data_master_limiter_rsp_src_data;                                            // NIOS_data_master_limiter:rsp_src_data -> NIOS_data_master_agent:rp_data
	...
	wire  [90:0] router_001_src_data;                                                              // router_001:src_data -> NIOS_instruction_master_limiter:cmd_sink_data
	...
	wire  [90:0] nios_instruction_master_limiter_cmd_src_data;                                     // NIOS_instruction_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire  [90:0] rsp_mux_001_src_data;                                                             // rsp_mux_001:src_data -> NIOS_instruction_master_limiter:rsp_sink_data
	...
	wire  [90:0] nios_instruction_master_limiter_rsp_src_data;                                     // NIOS_instruction_master_limiter:rsp_src_data -> NIOS_instruction_master_agent:rp_data
	...
	wire  [90:0] cmd_demux_001_src1_data;                                                          // cmd_demux_001:src1_data -> cmd_mux_006:sink1_data
	...
	wire  [90:0] rsp_demux_006_src1_data;                                                          // rsp_demux_006:src1_data -> rsp_mux_001:sink1_data
