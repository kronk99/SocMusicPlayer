...
(
    ...
    localparam PAD2 = log2ceil(64'h4804 - 64'h4800); 
    localparam PAD3 = log2ceil(64'h4814 - 64'h4810); 
    ...
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h4860;
    ...
    // ( 0x4800 .. 0x4804 )
    if ( {address[RG:PAD2],{PAD2{1'b0}}} == 15'h4800  && write_transaction  ) begin
            src_channel = 7'b0001000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 1;
    end

    // ( 0x4810 .. 0x4814 )
    if ( {address[RG:PAD3],{PAD3{1'b0}}} == 15'h4810  && read_transaction  ) begin
            src_channel = 7'b0100000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 2;
    end

    // ( 0x4820 .. 0x4840 )
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 15'h4820   ) begin
